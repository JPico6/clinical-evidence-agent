"""Live selection + deterministic observation-evidence retrieval experiment.

This intentionally stops before final clinical synthesis.
"""
...
def main() -> int:
    ...
    try:
        ...
        print()
        print("=== DETERMINISTIC SELECTED-OBSERVATION EVIDENCE ===")
